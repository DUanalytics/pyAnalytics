# -*- coding: utf-8 -*-
"""
Created on Tue Jun  4 07:52:17 2019 @author: du
"""
...
if not os.path.exists('airfares.txt'):  urllib.urlretrieve('http://www.stat.ufl.edu/~winner/data/airq4.dat','airfares.txt')
data= pd.read_csv('http://www.stat.ufl.edu/~winner/data/airq4.dat', sep=' +', header=0,names=['city1', 'city2', 'pop1', 'pop2', 'dist', 'fare_2000', 'nb_passengers_2000','fare_2001', 'nb_passengers_2001'])
# As a seperator, ' +' is a regular expression that means 'one of more
# space'
#data = pandas.read_csv('airfares.txt', sep=' +', header=0,        names=['city1', 'city2', 'pop1', 'pop2',  'dist', 'fare_2000', 'nb_passengers_2000', 'fare_2001', 'nb_passengers_2001'])
data.head()
...
import seaborn
seaborn.pairplot(data_flat, vars=['fare', 'dist', 'nb_passengers'],                 kind='reg', markers='.')

# A second plot, to show the effect of the year (ie the 9/11 effect)
seaborn.pairplot(data_flat, vars=['fare', 'dist', 'nb_passengers'],                 kind='reg', hue='year', markers='.')
