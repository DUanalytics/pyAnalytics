...
#https://raw.githubusercontent.com/parrt/dtreeviz/master/testing/gen_samples.py
import numpy as np
import pandas as pd
import graphviz
...
Run with working directory as main dtreeviz dir so this code can see dtreeviz packageand data paths are set correctly. 
"""
